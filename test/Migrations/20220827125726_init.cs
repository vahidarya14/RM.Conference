        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    Bg = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    AddsVideo = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SiteName = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    SiteLogo = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Url = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Img = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Title = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConferenceSponserRequest", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConferenceSponserRequest_Conferences_ConferenceId",
                        column: x => x.ConferenceId,
                        principalTable: "Conferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConferenceSpeaker", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "ConferenceSponser",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ConferenceId = table.Column<long>(type: "bigint", nullable: false),
                    SponserId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConferenceSponser", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConferenceSponser_Conferences_ConferenceId",
                        column: x => x.ConferenceId,
                        principalTable: "Conferences",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConferenceSponser_Sponsers_SponserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Avatar = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Title = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Newses_AspNetUsers_WriterId",
                        column: x => x.WriterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Setting",
                columns: new[] { "Id", "SiteLogo", "SiteName", "Theme" },
                values: new object[] { 1, null, null, "" });

            migrationBuilder.InsertData(
                table: "Speakers",
                columns: new[] { "Id", "Avatar", "Degree", "Description", "Email", "Facebook", "FullName", "Instagram", "Linkedin", "Phone", "Twitter" },
                values: new object[] { 1L, null, "bachelor", null, null, null, "William Shakespeare", null, null, null, null });

            migrationBuilder.InsertData(
                table: "Sponsers",
                columns: new[] { "Id", "Email", "Link", "Logo", "Phone", "Title" },
                values: new object[,]
                {
                    { 1L, null, null, null, null, "Hamlet" },
                    { 2L, null, null, null, null, "King Lear" },
                    { 3L, null, null, null, null, "Othello" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConferenceSponser_ConferenceId",
                table: "ConferenceSponser",
                column: "ConferenceId");

            migrationBuilder.CreateIndex(
                name: "IX_ConferenceSponser_SponserId",
                table: "ConferenceSponser",
                column: "SponserId");

            migrationBuilder.CreateIndex(
                name: "IX_ConferenceSponserRequest_ConferenceId",
                table: "ConferenceSponserRequest",
                column: "ConferenceId");

            migrationBuilder.CreateIndex(
                name: "IX_Newses_WriterId",
                table: "Newses",
                column: "WriterId");
        }
